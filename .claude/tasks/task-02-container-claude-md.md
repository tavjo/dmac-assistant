...
- `dmac-assistant-sds.md` — Software Design Specification (authoritative architectural reference)
- `dmac-assistant-adrs.md` — currently a duplicate of the SDS; treat the SDS as canonical until ADRs are written
```
...
- `dmac-assistant-sds.md` — Software Design Specification (authoritative architectural reference)
- `dmac-assistant-adrs.md` — ADRs capturing the *why* behind each architectural choice
...
(Note: the ADR description also gets corrected — the earlier spec-duplication note is obsolete since T0's spec rewrite was absorbed into an earlier commit.)
