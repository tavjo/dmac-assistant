...
| 4 | T3 runner/hard gate/resolution | implemented; review pending | pending | `out/T3.log`, `out/T3.xml`: T3 runner tests 27 passed, `_batch_upload_runner` coverage 99%, pin check pass | pending |
