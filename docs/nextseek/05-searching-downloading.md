...
## [hashtag](#page-7baNS1Y1qblWsOaQp2lJ-searching) Searching

### [hashtag](#page-7baNS1Y1qblWsOaQp2lJ-simple-search-page) [Simple Search Pagearrow-up-right](https://nextseek.mit.edu/seek/search/?tab=simple)
...
### [hashtag](#page-7baNS1Y1qblWsOaQp2lJ-advanced-search-page)
...
The resulting table is identical to the Simple Search page, with one additional feature: Send to Sample Retrieval. Following a search, you can select a subset of samples, and send them to

### [hashtag](#page-7baNS1Y1qblWsOaQp2lJ-search-by-uid) Search by UID
...
### [hashtag](#page-7baNS1Y1qblWsOaQp2lJ-searching-on-the-seek-website) Searching on the SEEK Website
...
## [hashtag](#page-7baNS1Y1qblWsOaQp2lJ-downloading) Downloading

### [hashtag](#page-7baNS1Y1qblWsOaQp2lJ-downloading-via-search-pages) Downloading via Search Pages
...
Attached below is an example of a downloaded file from NExtSEEK - with parents. This data is published already and associated with: .

### [hashtag](#page-7baNS1Y1qblWsOaQp2lJ-sample-retrieval)
...
### [hashtag](#page-7baNS1Y1qblWsOaQp2lJ-protocol-data-file-query-and-download) / Query and Download
...
### [hashtag](#page-7baNS1Y1qblWsOaQp2lJ-globus) Globus

is a cloud-based file transfer and storage service that allows users to move and share large amounts of data between different resources.
...
1. Register for a  account with your Institution email
2. Email  with your Globus Username and Project Association
...
The full Globus documentation exists here:

## [hashtag](#page-7baNS1Y1qblWsOaQp2lJ-deleting) Deleting

### [hashtag](#page-7baNS1Y1qblWsOaQp2lJ-deleting-samples) Deleting Samples
...
### [hashtag](#page-7baNS1Y1qblWsOaQp2lJ-deleting-protocols-and-data-files) Deleting Protocols and Data Files
